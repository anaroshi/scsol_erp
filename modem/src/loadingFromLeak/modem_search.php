...
while ($row = mysqli_fetch_array($result)) {
  ...
  $modemList .= "
      ...
      <td class ='d_modem d_rate' hidden>$rate</td>
      <td class ='d_modem d_monthlyFee' hidden>$monthlyFee</td>
      ...
      <td class ='d_modem d_product_cd' hidden>$product_cd</td>
      <td class ='d_modem d_version' hidden>$version</td>
      <td class ='d_modem d_sn' name='sn_asc'>$sn</td>
      <td class ='d_modem d_sid'>$sid</td>
      <td class ='d_modem d_project'>$project</td>
      ...
      <div class="modem_down">
        <table class='modem'>
          <thead class='th_modem'>
            ...
            <th class='h_modem h_modem_b h_rate' hidden>>요금제</th>
            <th class='h_modem h_modem_b h_monthlyFee' hidden>>약정</th>
            ...
            <th class='h_modem h_modem_b h_product_cd' hidden>PRODUCT CODE</th>
            <th class='h_modem h_modem_b h_version' hidden>>VERSION</th>
            <th class='h_modem h_modem_b h_sn'>SCSOL S/N</th>
            <th class='h_modem h_modem_b h_sid'>SID</th>
            <th class='h_modem h_modem_b h_project'>PROJECT</th>
