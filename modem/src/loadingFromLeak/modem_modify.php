...
$response = "
  <table class='modem_mdy'>
    ...
    <tr>
      <th><label class='modem_h' for='sid'>SID</label></th>
      <td><input type='text' class='modem_l modem_sid' value = '$sid' readonly/></td>
    </tr>
    <tr>
      <th><label class='modem_h' for='project'>PROJECT</label></th>
      <td><input type='text' class='modem_l modem_project' value = '$project' readonly/></td>
    </tr>
    <tr>
